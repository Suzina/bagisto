                                            ...
                                            @foreach ($order->items as $item)
                                                <tr>
                                                    ...
                                                    <td data-value="{{ __('shop::app.customer.account.order.view.grand-total') }}">
                                                        Rs {{$item->total + $item->tax_amount - $item->discount_amount }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <table class="sale-summary">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>-</td>
                                                <td>Rs {{ $order->order_currency_code }}</td>
                                            </tr>
