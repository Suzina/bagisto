<div class="order-summary">
    ...
    <div class="item-detail">
        ...
        <label class="right">Rs {{ $cart->base_sub_total }}</label>
    </div>

    @if ($cart->selected_shipping_rate)
        <div class="item-detail">
            <label>{{ __('shop::app.checkout.total.delivery-charges') }}</label>
            <label class="right">Rs {{ $cart->selected_shipping_rate->base_price }}</label>
        </div>
    @endif
    ...
    @if ($cart->base_tax_total)
        <div class="item-detail">
            ...
            <label class="right">Rs {{ $cart->base_tax_total }}</label>
        </div>
    @endif
