                            ...
                            <div slot="body">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($order->items as $item)
                                                <tr>
                                                    ...
                                                    <td>Rs {{ $item->base_tax_amount }}</td>

                                                    @if ($order->base_discount_amount > 0)
                                                        <td>Rs {{ $item->base_discount_amount }}</td>
                                                    @endif

                                                    <td>Rs {{ $item->base_total + $item->base_tax_amount - $item->base_discount_amount }}</td>
                                                </tr>
                                            @endforeach
                                    </table>
                                </div>
                                ...
                                <table class="sale-summary">
                                    <tr>
                                        ...
                                        <td>-</td>
                                        <td>Rs {{ $order->base_sub_total }}</td>
                                    </tr>

                                    <tr>
                                        <td>{{ __('admin::app.sales.orders.shipping-handling') }}</td>
                                        <td>-</td>
                                        <td>Rs {{$order->base_shipping_amount }}</td>
                                    </tr>
                                    ...
                                    @if ($order->base_discount_amount > 0)
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <td>Rs {{ $order->base_discount_amount }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    <tr class="border">
                                        ...
                                        <td>-</td>
                                        <td>Rs {{ $order->base_tax_amount }}</td>
                                    </tr>

                                    <tr class="bold">
                                        <td>{{ __('admin::app.sales.orders.grand-total') }}</td>
                                        <td>-</td>
                                        <td>Rs {{ $order->base_grand_total }}</td>
                                    </tr>

                                    <tr class="bold">
                                        <td>{{ __('admin::app.sales.orders.total-paid') }}</td>
                                        <td>-</td>
                                        <td>Rs {{ $order->base_grand_total_invoiced }}</td>
                                    </tr>

                                    <tr class="bold">
                                        <td>{{ __('admin::app.sales.orders.total-refunded') }}</td>
                                        <td>-</td>
                                        <td>Rs {{ $order->base_grand_total_refunded }}</td>
                                    </tr>

                                    <tr class="bold">
                                        <td>{{ __('admin::app.sales.orders.total-due') }}</td>
                                        <td>-</td>
                                        <td>Rs {{ $order->base_total_due }}</td>
                                    </tr>
                                </table>
                            ...
                            <tbody>
                                ...
                                @foreach ($order->invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>Rs {{ $invoice->base_grand_total }}</td>
                                        <td class="action">
